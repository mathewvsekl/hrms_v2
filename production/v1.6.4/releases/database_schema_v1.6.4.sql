...
-- Last Updated: 2026-03-23 (v1.6.4 AUDITED_ALIGNMENT)
...
CREATE TABLE `attendance_logs` (
  ...
  `status` ENUM('present', 'absent', 'half_day', 'late', 'on_leave', 'public_holiday', 'weekend', 'training', 'on_site', 'work_from_home') DEFAULT 'present',
