...
class CompanyDocumentController extends Controller
{
    ...
    public function getAllDocuments()
    {
        ...
        if (!$isGlobalAdmin && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'HRASSISTANT', 'HR_ASSISTANT', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
    ...
    public function uploadDocument()
    {
        ...
        // Permission check
        if (!$this->isGlobalAdmin() && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'HRASSISTANT', 'HR_ASSISTANT', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
    ...
    public function updateDocument($id)
    {
        ...
        if (!$this->isGlobalAdmin() && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
