...
class EmployeeController extends Controller
{
    ...
    public function updateEmployee($requestData)
    {
        ...
        try {
            ...
            file_put_contents(BASE_PATH . '/tmp/update_error.log', "PAYLOAD: " . json_encode($requestData) . "\nEXCEPTION: " . $e->getMessage() . "\n" . $e->getTraceAsString());
    ...
    public function listEmployees()
    {
        try {
            ...
            if ($this->isGlobalAdmin()) {
                ...
                $isCountryManager = $this->hasAnyRole(['CountryManager', 'COUNTRY MANAGER', 'COUNTRYMANAGER']);

                // Exception: Country Managers can view global public profiles in the 'employee' directory view.
                if ($isCountryManager && $viewMode === 'employee') {
