-- HRMS V2 Database Patch: v3.0.29-hrms (Cumulative from v3.0.28-emm)
-- Includes:
-- 1. RBAC Security Audit Orchestration (base_role_id)
-- 2. StringNormalizer Updates (normalized_name)
-- 3. Attendance & Permission Error Resolving (Insert missing permissions)
