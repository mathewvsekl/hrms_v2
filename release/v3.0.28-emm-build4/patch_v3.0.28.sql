...
ALTER TABLE `payroll_records` ADD COLUMN `reporting_currency` VARCHAR(10) DEFAULT 'AED' AFTER `basic_pay`;
...
ALTER TABLE `companies` MODIFY COLUMN `logo_url` LONGTEXT NULL;
