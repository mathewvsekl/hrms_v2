-- Company Settings
ALTER TABLE `company_settings` MODIFY `logo_url` LONGTEXT;

-- Company Settings Leave Types
ALTER TABLE `company_settings_leave_types` ADD COLUMN `year` INT DEFAULT NULL AFTER `leave_type_id`;

-- Employees
ALTER TABLE `employees` ADD COLUMN `include_in_payroll` TINYINT(1) DEFAULT '0' AFTER `is_primary`;

-- Employee Fixed Deductions
ALTER TABLE `employee_fixed_deductions` MODIFY `amount` DECIMAL(15,2) DEFAULT NULL;
...
ALTER TABLE `salary_configurations` MODIFY `base_salary` DECIMAL(15,2) DEFAULT NULL;
ALTER TABLE `salary_configurations` MODIFY `commissions` DECIMAL(15,2) DEFAULT NULL;
ALTER TABLE `salary_configurations` MODIFY `other_earnings` DECIMAL(15,2) DEFAULT NULL;
ALTER TABLE `salary_configurations` ADD COLUMN `personal_relief` DECIMAL(10,2) DEFAULT '0.00' AFTER `updated_at`;
