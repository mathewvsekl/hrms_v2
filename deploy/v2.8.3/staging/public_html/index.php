...
if (file_exists(BASE_PATH . '/app/Helpers/CacheHelper.php')) {
    require_once BASE_PATH . '/app/Helpers/CacheHelper.php';
}
...
if (file_exists(BASE_PATH . '/app/Controllers/CompanyDocumentController.php')) {
    require_once BASE_PATH . '/app/Controllers/CompanyDocumentController.php';
}
