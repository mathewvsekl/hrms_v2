-- HRMS V2 Migration Patch v2.6.8
-- Generated on 2026-05-12

-- 1. Leave Type Multi-Company Isolation
-- Replace global unique code with company-specific unique constraint
ALTER TABLE leave_types DROP INDEX code;
ALTER TABLE leave_types ADD UNIQUE KEY `unique_company_code` (`company_id`, `code`);
