    ...
    public function getDashboardStats()
    {
        try {
            ...
            $holidayQuery = "
                ...
                " . ($isGlobalAdmin ? "" : "AND h.company_id IN (SELECT company_id FROM employee_companies WHERE is_active=1 $companyFilter)") . "
            ";
            ...
            $pubHolidayQuery = "
                ...
                " . ($isGlobalAdmin ? "" : "AND p.country_id IN (SELECT c.country_id FROM companies c JOIN employee_companies ec ON c.id = ec.company_id WHERE ec.is_active=1 $companyFilter)") . "
            ";
