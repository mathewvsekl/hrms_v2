...
<body style='background-color: $brandBg; padding: 40px 0; margin: 0; width: 100% !important;'>
    <div style='max-width: 550px; margin: 0 auto; background-color: #ffffff; padding: 40px 35px; border-radius: 16px; border: 1px solid $brandBorder;'>
        <h2 style='color: $brandPrimary; margin: 0 0 16px 0;'>Welcome to Avantgarde HRMS, " . htmlspecialchars($userName) . "!</h2>
        <p style='font-size: 14px; line-height: 1.6; margin: 0 0 25px 0;'>
            Your account has been successfully created. You can now log in to the system using your email address and a secure OTP (One-Time Password) at the following link:
        </p>
        <div style='text-align: center; margin-bottom: 25px;'>
            <a href='https://hrms.anedins.com/' style='display: inline-block; background-color: $brandPrimary; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px;'>Login to HRMS</a>
        </div>
        <p style='font-size: 14px; color: #4B5563; margin: 0 0 25px 0;'>
            If the button doesn't work, you can copy and paste this URL into your browser: <br><a href='https://hrms.anedins.com/' style='color: $brandPrimary;'>https://hrms.anedins.com/</a>
        </p>
        <p style='font-size: 12px; color: #9CA3AF; margin: 0;'>&copy; " . date('Y') . " Avantgarde HRMS Team. All rights reserved.</p>
    </div>
</body>
</html>";
        ...
        $text .= "You can log in using your email and an OTP at: https://hrms.anedins.com/\n\n";
        $text .= "==================================================\n";
        $text .= "© " . date('Y') . " Avantgarde HRMS Team.";
