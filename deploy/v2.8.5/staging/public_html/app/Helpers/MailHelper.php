...
class MailHelper
{
    public static function sendOTP(string $email, string $otp, ?string $userName = null, ?string $referenceCode = null): bool
    {
        ...
        $subject = "Your HRMS Verification Code: $referenceCode";
...
<body style='background-color: $brandBg; padding: 40px 0; margin: 0; width: 100% !important;'>
    ...
    <table border='0' cellpadding='0' cellspacing='0' width='100%' style='background-color: $brandBg;'>
                ...
                <table class='email-container' border='0' cellpadding='0' cellspacing='0' width='550' style='max-width: 550px; margin: 0 auto;'>
                    ...
                    <tr>
                        <td class='card-body' style='background-color: #ffffff; padding: 40px 35px; border-radius: 16px; border: 1px solid $brandBorder; box-shadow: 0 10px 15px -3px rgba(26, 28, 32, 0.04), 0 4px 6px -2px rgba(26, 28, 32, 0.02);'>
                            ...
                            <table border='0' cellpadding='0' cellspacing='0' width='100%' style='margin-bottom: 25px;'>
                                <tr>
                                    <td align='center' style='background-color: $brandBg; border: 2px dashed $brandPrimary; border-radius: 12px; padding: 22px; text-align: center;'>
                                        <div class='otp-code' style='font-family: \"Outfit\", monospace; font-size: 38px; font-weight: 800; color: $brandPrimary; letter-spacing: 8px; line-height: 1.2; margin-bottom: 4px;'>$otp</div>
                                        <div style='font-family: \"Outfit\", sans-serif; font-size: 11px; color: $brandGold; font-weight: 600; letter-spacing: 2px; text-transform: uppercase;'>Verification Reference: $referenceCode</div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <!-- Request Context -->
                            <table class='security-table' border='0' cellpadding='0' cellspacing='0' width='100%' style='background-color: $brandBg; border-radius: 12px; border: 1px solid $brandBorder; padding: 14px 18px; margin-bottom: 25px;'>
                                <tr>
                                    <td style='padding-bottom: 8px;'>
                                        <span style='font-size: 10px; font-weight: 600; color: #9CA3AF; text-transform: uppercase; display: block;'>IP Address</span>
                                        <span style='font-size: 13px; font-weight: 600; color: $brandDark; font-family: monospace;'>$ip</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style='padding-bottom: 8px; border-top: 1px solid rgba(0,0,0,0.04); padding-top: 8px;'>
                                        <span style='font-size: 10px; font-weight: 600; color: #9CA3AF; text-transform: uppercase; display: block;'>Device / OS</span>
                                        <span style='font-size: 13px; font-weight: 600; color: $brandDark; font-family: \"Inter\", sans-serif;'>$deviceStr</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style='border-top: 1px solid rgba(0,0,0,0.04); padding-top: 8px;'>
                                        <span style='font-size: 10px; font-weight: 600; color: #9CA3AF; text-transform: uppercase; display: block;'>Requested At</span>
                                        <span style='font-size: 13px; font-weight: 600; color: $brandDark; font-family: \"Inter\", sans-serif;'>$timeStr</span>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style='padding: 25px 10px 0 10px; font-size: 11px; color: #9CA3AF; text-align: center; line-height: 1.8;'>
        ...
        $text .= "OTP CODE: $otp\n";
        $text .= "Verification Reference: $referenceCode\n";
        $text .= "Expires at: $expiresAt\n\n";
        $text .= "SECURITY DETAILS:\n";
        $text .= "IP Address: $ip\n";
        $text .= "Device / OS: $deviceStr\n";
        $text .= "Requested At: $timeStr\n\n";
