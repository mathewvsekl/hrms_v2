...
class AttendanceController extends Controller
{
    ...
    public function getMonthlyReport($requestData)
    {
        try {
            ...
            // Fetch Leave Types
            $leaveTypeQuery = "SELECT code, name, color FROM leave_types";
    ...
    public function exportMonthlyReport($requestData)
    {
        try {
            ...
            // To reuse the existing logic, we capture the JSON output and decode it
            // This is a quick way to maintain consistency in reporting
            ob_start();
            $this->getMonthlyReport($requestData);
