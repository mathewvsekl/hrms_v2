...
class EmployeeController extends Controller
{
    ...
    public function getDashboardStats()
    {
        try {
            ...
            $isGlobalAdmin = $this->isGlobalAdmin();
            if (!$isGlobalAdmin) {
                $isMultiOffice = $this->hasAnyRole(['HRManager', 'HR_MANAGER', 'HR MANAGER', 'HRAssistant', 'HR_ASSISTANT', 'HR ASSISTANT', 'CountryManager', 'COUNTRY MANAGER', 'COUNTRY_MANAGER', 'COUNTRYMANAGER']);
    ...
    public function listEmployees()
    {
        try {
            ...
            } else if ($this->hasAnyRole(['HRManager', 'HR_MANAGER', 'HR MANAGER', 'HRAssistant', 'HR_ASSISTANT', 'HR ASSISTANT', 'CountryManager', 'COUNTRY MANAGER', 'COUNTRYMANAGER'])) {
