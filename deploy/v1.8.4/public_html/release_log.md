# Release Notes
**Version**: v1.8.4 (STABLE — FULL FEATURE SYNC)
**Date**: 2026-03-27
**Build**: 1804
**Baseline**: v1.8.3

## Changes (v1.8.4 — Cumulative from v1.8.3 → v1.8.4):

### Database Migration (RUN FIRST)
- Run `migration_patch_v1.8.4.sql` via phpMyAdmin BEFORE deploying backend
