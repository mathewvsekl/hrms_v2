...
class AuthController extends Controller
{
    ...
    public function requestOTP()
    {
        ...
        try {
            ...
            if (!$user) {
                MailHelper::logManual("OTP Request Rejected: User not found for email [$email]");
                return $this->jsonResponse(null, 404, "User not found or account inactive.");
            }

            if ($user['is_active'] != 1) {
                MailHelper::logManual("OTP Request Rejected: Account inactive for email [$email]");
                return $this->jsonResponse(null, 403, "Account is disabled.");
            }
