...
class CompanyDocumentController extends Controller
{
    ...
    public function getAllDocuments()
    {
        ...
        if (!$this->isGlobalAdmin() && !$this->hasEntityScope('configuration')) {
            return $this->jsonResponse(null, 403, "Insufficient permissions to upload documents.");
        }
    ...
    public function updateDocument($id)
    {
        ...
        if (!$this->isGlobalAdmin() && !$this->hasEntityScope('configuration')) {
            return $this->jsonResponse(null, 403, "Insufficient permissions to modify documents.");
        }
