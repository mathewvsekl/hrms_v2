...
class RbacController extends Controller
{
        ...
        try {
            ...
            if (!$this->isSuperAdmin()) {
                $roles = array_filter($roles, function ($role) {
                    return (int)$role['id'] !== \App\Helpers\RoleConstants::SUPER_ADMIN;
                });
    ...
    public function listPermissions()
    {
        try {
            ...
            if (!in_array('Documents', $allModules)) $allModules[] = 'Documents';
            if (!in_array('Admin Portal', $allModules)) $allModules[] = 'Admin Portal';
