...
class CompanyDocumentController extends Controller
{
    ...
    public function getAllDocuments()
    {
        ...
        if (!$isGlobalAdmin && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'HR MANAGER', 'HRASSISTANT', 'HR_ASSISTANT', 'HR ASSISTANT', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
    ...
    public function uploadDocument()
    {
        ...
        // Permission check
        if (!$this->isGlobalAdmin() && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'HR MANAGER', 'HRASSISTANT', 'HR_ASSISTANT', 'HR ASSISTANT', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
        ...
        if (!$this->isGlobalAdmin()) {
            ...
            if (!$companyId && !empty($myCompanyIds)) {
                ...
                if ($this->hasAnyRole(['COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
                    $companyId = $_SESSION['scope_company_id'] ?? null;
                }
            }
    ...
    public function updateDocument($id)
    {
        ...
        if (!$this->isGlobalAdmin() && !$this->hasAnyRole(['HRMANAGER', 'HR_MANAGER', 'HR MANAGER', 'COUNTRYMANAGER', 'COUNTRY_MANAGER', 'COUNTRY MANAGER'])) {
